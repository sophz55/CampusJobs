...
- (instancetype)initStandardSingleton {
    ...
    if (self) {
        ...
        _typographyScheme.headline3 = [UIFont fontWithName:regularFontName size:48.0];
        _typographyScheme.headline4 = [UIFont fontWithName:regularFontName size:34.0];
        _typographyScheme.headline5 = [UIFont fontWithName:regularFontName size:24.0];
        _typographyScheme.headline6 = [UIFont fontWithName:boldFontName size:20.0];
        _typographyScheme.subtitle1 = [UIFont fontWithName:lightFontName size:16.0];
        _typographyScheme.subtitle2 = [UIFont fontWithName:boldFontName size:14.0];
        _typographyScheme.body1 = [UIFont fontWithName:regularFontName size:16.0];
        _typographyScheme.body2 = [UIFont fontWithName:regularFontName size:14.0];
